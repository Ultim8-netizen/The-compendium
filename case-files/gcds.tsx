    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .pg { font-family: 'Georgia', serif; background: #ffffff; color: #1a1a2e; padding: 0; }
        ...
        .condition-alias { font-size: 13px; color: #555; font-style: italic; margin-bottom: 1.5rem; }
        ...
        .body-text { font-size: 13px; line-height: 1.75; color: #1a1a2e; }
        ...
        .crit-text { font-size: 13px; line-height: 1.6; color: #1a1a2e; }
        ...
        .case-text { font-size: 12.5px; line-height: 1.65; color: #1a1a2e; }
        ...
        .stage-text { font-size: 13px; line-height: 1.6; color: #1a1a2e; }
        .prognosis-bar { height: 8px; background: #eee; border-radius: 0; margin: 0.3rem 0 0.2rem; overflow: hidden; }
        .prognosis-fill { height: 100%; }
        .prognosis-label { display: flex; justify-content: space-between; font-size: 10px; font-family: 'Courier New', monospace; color: #555; }
        ...
        .int-text { font-size: 13px; line-height: 1.65; color: #1a1a2e; }
        .redact { background: #1a1a2e; color: #1a1a2e; border-radius: 1px; padding: 0 3px; user-select: none; }
          ...
          <div className="two-col">
            ...
            <div>
              ...
              {[
                ...
                <div key={row.label}>
                  <div style={{ fontSize: '12px', fontFamily: "'Courier New', monospace", color: '#444', marginBottom: '4px', marginTop: '8px' }}>{row.label}</div>
